...
onValue(productsRef, (snapshot) => {
    ...
    if (productsData.length === 0) {
        ...
        productsData.slice(0, 9).forEach((product) => {
            let { name, category, price, description, discountPercentage, rating, brand, thumbnail } = product;
...
let categoryAccordion = document.getElementById("category-accordion");
categoryAccordion.onclick = function () {
